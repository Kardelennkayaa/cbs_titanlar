...
function visualize() {
  location.replace("https://hacettepesemtservisleri.herokuapp.com/")
}
...
function SaveDatatodb(){
    ...
    if (location != '' && recorder != '' && long != '' && lat != '' && minibus_name != '' ){
      $('#pointadding').modal('hide');
        ...
        alert('Durak bilgisi eklendi!')
    } else {
        alert('Lütfen boş bırakılan alanları doldurun!')
    }
...
function SaveDatatodb_route(){
  ...
  var driver = document.getElementById('driver_route').value;
  var contact = document.getElementById('contact_route').value;
  var startTime = document.getElementById('starttime_route').value;
  var path_def = document.getElementById('path_def_route').value;
  if (location != '' && recorder != '' && geom != '' &&  minibus_name != '' &&  distance != '' && driver != '' && contact != '' && startTime != '' && path_def != '')   {
    $('#route_adding').modal('hide')
        ...
        alert('Servis bilgileri eklendi!')
    } else {
        alert('Lütfen boş bırakılan alanları doldurun!')
    }
}
...
function creatingGeojson(arrayofdata){
  ...
  var unique_location = [];
  unique_location.push("Güzergah Adı Seç");
